...
db=sqlite3.connect('/home/budi/mobileApps/Code/try_insert_data.db')
dataframe = '/home/budi/mobileApps/Code/test_data.json'
with open(dataframe, encoding='utf-8-sig') as json_file:
